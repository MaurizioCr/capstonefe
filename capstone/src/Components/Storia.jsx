  ...
  return (
    <div>
      ...
      <Container>
        ...
        <Col>
            <p className='animate__animated animate__fadeInRight text-white bg-secondary p-2 rounded'>
            ...
            <p className='animate__animated animate__fadeInLeft text-white bg-secondary p-2 rounded'>
